...
namespace JobRecruitment.DAL.Migrations
{
    ...
    partial class JobRecruitmentDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobRecruitment.Core.Entities.JobOffer", b =>
                {
                    b.HasOne("JobRecruitment.Core.Entities.Category", "Category")
                        .WithMany("JobOffers")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JobRecruitment.Core.Entities.Employer", "Employer")
                        .WithMany("PostedJobs")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JobRecruitment.Core.Entities.User", null)
                        .WithMany()
